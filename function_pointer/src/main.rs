// function pointers are similar to closures except that they don't capture the variable in the environment
struct User {
    name: String,
    age: u8,
    salary: u32,
...
fn main() {
    ...
    is_valid_user(&person_1.name, banned_user, person_1.age, validate_user_simple, validate_user_advance)
);
